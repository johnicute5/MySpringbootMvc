...
<div class="container">
    <h2 class="home">Manager Enrollment Form</h2>
    <form:form modelAttribute="managerForm" action="addManagerAction"
               method="post" class="myform">
        <p>Manager Employee Number</p>
        <form:input type="text" name="employeeNumber"
                    placeholder="Enter Manager Employee Number.." path="employeeNumber"/>
        ...
        <p>hiring date</p>
        <form:input type="date" name="lastNmae" placeholder="Write your hiring date.."
                    path="hiringDate"/>
        <form:errors path="hiringDate" class="error"></form:errors>

        <%--        <form:select path="" >--%>
        <%--            <form:option value="Human Resources"/>--%>
        <%--            <form:option value="Career Development"/>--%>
        <%--            <form:option value="Accounting and Finance"/>--%>
