...
<h2 class="home">Learner Employees Table</h2>
<div class="container">
    <a href="addLearner"
       style=" text-decoration: none;padding:10px; background:#a50319;color: #ffffff;font-family:Helvetica Neue, Helvetica, Arial, sans-serif; margin-left: 5px;">Add
        Learner </a>
    <a href="listEmployee"
       style=" margin: 10px; text-decoration: none;padding:10px; background:#a50319;color: #ffffff;font-family:Helvetica Neue, Helvetica, Arial, sans-serif ;">Employees
        List </a>
    <table class="table">
        <tr>
        ...
        <c:forEach var="employee" items="${myListLearner}">
            <tr>
			...
			/updateListLearner?learnerId=${employee.employeeNumber}"
				   ...
				   /delListLearner?learnerId=${employee.employeeNumber}"
