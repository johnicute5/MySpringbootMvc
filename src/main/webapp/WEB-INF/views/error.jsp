...
<div class="container">
    <h2 class="home">Search</h2>


    <p style="color:#a50319;font-style: italic;font-size: 25px;">${error}</p>
    <form:form modelAttribute="myEmp" action="searchEmployee"
               method="post" class="myform">
        <p>Employee Number</p>
        <form:input type="text" name="employeeNumber"
                    placeholder="Write your Employee Number.." path="employeeNumber"/>
        <form:errors path="employeeNumber" class="thisError"></form:errors>
