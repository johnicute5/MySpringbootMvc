...
<h2 class="home">Employee's Profile</h2>
...
<div align="center">
    <br></br>
    <a href="addLearner"
       style="text-decoration: none;padding:7px; background:#CB1926;color: #ffffff;font-family:Helvetica Neue, Helvetica, Arial, sans-serif">Add
        New Learner </a>
    <br></br>
    <a href="listEmployee"
       style="text-decoration: none;padding:7px; background:#CB1926;color: #ffffff;font-family:Helvetica Neue, Helvetica, Arial, sans-serif">
        Employees List</a>
</div>
