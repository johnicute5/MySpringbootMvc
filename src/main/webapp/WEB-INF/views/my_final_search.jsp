...
<div class="container">
    <h2 class="home">Learner Details</h2>


    <p>Employee Number</p>
    <p style="width: 100%; background: #f1f1f1">  ${res.employeeNumber}</p>
    <p>First Name</p>
    <p style="width: 100%; background: #f1f1f1">${res.firstName}</p>
    <p>Last Name:</p>
    <p style="width :100%; background: #f1f1f1">${res.lastName}</p>
    <p>Hiring Date</p>
    <p style="width: 100%; background: #f1f1f1">${res.hiringDate}</p>
    <p>Role</p>
    <p style="width: 100%; background: #f1f1f1">${res}</p>
